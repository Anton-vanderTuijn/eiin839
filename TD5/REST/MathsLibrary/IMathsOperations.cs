...
namespace MathsLibrary
{
    ...
    public interface IMathsOperations
    {
        ...
        [OperationContract]
        [WebInvoke(Method = "GET", UriTemplate = "Subtract?a={a}&b={b}", BodyStyle = WebMessageBodyStyle.Wrapped, ResponseFormat = WebMessageFormat.Json)]
        int Subtract(int a, int b);

        [OperationContract]
        [WebInvoke(Method = "POST", UriTemplate = "Devide?a={a}&b={b}", BodyStyle = WebMessageBodyStyle.Wrapped, ResponseFormat = WebMessageFormat.Json)]
